...
// node_modules/@plotwell/editor/dist/index.esm.js
var g = new Schema({
  nodes: {
    doc: { content: "block+" },
    sceneHeading: {
      ...
      toDOM: () => [
        "p",
        {
          ...
          "data-placeholder": "INT. SCENE - DAY"
        },
        0
      ],
    ...
    parenthetical: {
      ...
      toDOM: () => [
        "p",
        {
          class: "pm-parenthetical",
          "data-type": "parenthetical",
          "data-placeholder": "beat"
        },
        0
      ],
    ...
    transition: {
      ...
      toDOM: (e) => [
        "p",
        {
          class: "pm-transition" + (e.textContent.toUpperCase().includes("FADE IN") ? " pw-fade-in" : ""),
          "data-type": "transition",
          "data-placeholder": "CUT TO:"
        },
        0
      ],
...
function y(e) {
  ...
  return t.parent.type.name;
}
var ee = (e, t) => {
  let { $from: n, $to: r } = e.selection;
  if (!n.sameParent(r)) return false;
  let i = y(e);
  if (!i) return false;
  let a = _[i] ?? "action", o = g.nodes[a];
  if (!o) return false;
  let s = n.parent, c = s.content.size > 0, l = n.parentOffset === 0;
  if (n.parentOffset, s.content.size, !c && i !== "action") {
    if (t) {
      let r2 = n.before();
      t(e.tr.setNodeMarkup(r2, g.nodes.action).scrollIntoView());
    }
    return true;
  }
  if (!c) return t && t(e.tr.split(n.pos, 1, [{ type: g.nodes.action }]).scrollIntoView()), true;
  if (l && c) {
    if (t) {
      let r2 = n.before(), i2 = g.nodes.action.create(), a2 = e.tr.insert(r2, i2), o2 = e.selection.constructor;
      a2 = a2.setSelection(o2.near(a2.doc.resolve(r2 + i2.nodeSize + 1))), t(a2.scrollIntoView());
    }
    return true;
  }
  return t && t(e.tr.split(n.pos, 1, [{ type: o }]).scrollIntoView()), true;
};
var te = (e, t) => {
  let n = y(e);
  if (!n) return false;
  let r = v[(v.indexOf(n) + 1) % v.length], i = g.nodes[r];
  if (!i) return false;
  if (t) {
    let { from: n2, to: r2 } = e.selection;
    t(e.tr.setBlockType(n2, r2, i));
  }
  return true;
};
var b = (e, t) => {
  let n = y(e);
  if (!n) return false;
  let r = v[(v.indexOf(n) - 1 + v.length) % v.length], i = g.nodes[r];
  if (!i) return false;
  if (t) {
    let { from: n2, to: r2 } = e.selection;
    t(e.tr.setBlockType(n2, r2, i));
...
var ne = (e, t) => {
  let { $from: n, empty: r } = e.selection;
  if (!r || n.parentOffset !== 0) return false;
  let i = y(e);
  if (!i || i === "action") return false;
  let a = n.parent, o = n.before(), s = e.doc.resolve(o).nodeBefore;
  if (!s) return true;
  if (s.content.size === 0) return t && t(e.tr.delete(o - s.nodeSize, o).scrollIntoView()), true;
  if (a.content.size === 0) {
    if (t) {
      let n2 = o + a.nodeSize, r2 = e.tr.delete(o, n2), i2 = e.selection.constructor.near(r2.doc.resolve(o - 1), -1);
      t(r2.setSelection(i2).scrollIntoView());
    }
    return true;
  }
  if (t) {
    let n2 = o - 1, r2 = e.selection.constructor.near(e.tr.doc.resolve(n2), -1);
    t(e.tr.setSelection(r2).scrollIntoView());
  }
  return true;
};
function x(e) {
  return (t, n) => {
    ...
    if (!r) return false;
    if (n) {
      let { from: e2, to: i } = t.selection;
      n(t.tr.setBlockType(e2, i, r));
    }
    return true;
  };
}
var S = keymap({
  ...
  "Shift-Tab": b,
  Backspace: ne,
  "Mod-b": toggleMark(g.marks.bold),
  "Mod-i": toggleMark(g.marks.italic),
  "Mod-u": toggleMark(g.marks.underline),
  "Mod-1": x("sceneHeading"),
  "Mod-2": x("action"),
  "Mod-3": x("character"),
  "Mod-4": x("dialogue"),
  "Mod-5": x("parenthetical"),
  "Mod-6": x("transition")
});
var re = inputRules({ rules: [new InputRule(/^(INT\.|EXT\.|INT\/EXT\.|I\/E\.)\s$/, (e, t, n, r) => e.doc.resolve(n).parent.type === g.nodes.sceneHeading ? null : e.tr.setBlockType(n, r, g.nodes.sceneHeading)), new InputRule(/^(FADE OUT\.|FADE IN:|CUT TO:|SMASH CUT TO:|DISSOLVE TO:)\s$/, (e, t, n, r) => e.doc.resolve(n).parent.type === g.nodes.transition ? null : e.tr.setBlockType(n, r, g.nodes.transition))] });
var C = 96;
var w = 864;
var T = new PluginKey("pagination");
var E = /* @__PURE__ */ new Set(["character"]);
var D = /* @__PURE__ */ new Set(["dialogue", "parenthetical"]);
var ie3 = new Plugin({
  key: T,
  state: {
    init: () => DecorationSet.empty,
    apply(e, t) {
      return e.getMeta(T) ?? t.map(e.mapping, e.doc);
    }
  },
  props: { decorations(e) {
    return T.getState(e);
  ...
  view(e) {
    let t = null, n = "";
    function a() {
      if (!e.dom || !e.dom.parentNode) return;
      let { state: t2 } = e, a2 = [];
      t2.doc.forEach((t3, n2) => {
        if (t3.type.name === "pageBreak") return;
        let r;
        try {
          r = e.nodeDOM(n2);
        } catch {
        ...
        if (!r) return;
        let i = window.getComputedStyle(r), o3 = parseFloat(i.marginTop) || 0, s2 = parseFloat(i.marginBottom) || 0, c2 = r.offsetHeight + o3 + s2;
        a2.push({
          pos: n2,
          height: c2,
          typeName: t3.type.name
        });
      });
      let o2 = [], s = 1, c = 0;
      for (let e2 = 0; e2 < a2.length; e2++) {
        let t3 = a2[e2];
        if (c + t3.height > w && c > 0) {
          let n2 = e2;
          if (D.has(t3.typeName) && e2 > 0) {
            let t4 = e2 - 1;
            for (; t4 >= 0 && D.has(a2[t4].typeName); ) t4--;
            t4 >= 0 && a2[t4].typeName === "character" && (n2 = t4);
          }
          E.has(t3.typeName) && (n2 = e2), n2 <= 0 && (n2 = e2), s++, o2.push(a2[n2].pos), c = 0;
          for (let t4 = n2; t4 <= e2; t4++) c += a2[t4].height;
        } else c += t3.height;
      }
      let l = JSON.stringify(o2);
      if (l === n) return;
      n = l;
      let u = [];
      o2.forEach((e2, t3) => {
        let n2 = t3 + 2;
        u.push(Decoration.widget(e2, () => {
          let e3 = document.createElement("div");
          e3.className = "pw-page-separator", e3.contentEditable = "false";
          let t4 = document.createElement("div");
          t4.className = "pw-page-margin-bottom", e3.appendChild(t4);
          let r = document.createElement("div");
          r.className = "pw-page-margin-top";
          let i = document.createElement("span");
          return i.className = "pw-page-header-number", i.textContent = `${n2}.`, r.appendChild(i), e3.appendChild(r), e3;
        }, {
          side: -1,
          key: `page-${n2}`
        }));
      });
      let d = w - c, f = Math.max(0, d);
      e.dom.style.paddingBottom = `${C + f}px`;
      let p = DecorationSet.create(t2.doc, u), m = t2.tr.setMeta(T, p);
      m.setMeta("addToHistory", false), e.dispatch(m);
    }
    function o() {
...
var ae = new PluginKey("bubbleMenu");
var oe = [
  {
    mark: "bold",
    label: "Bold",
...
function se(e, t) {
  let { from: n, $from: r, to: i, empty: a } = e.state.selection, o = g.marks[t];
  return a ? !!o.isInSet(e.state.storedMarks || r.marks()) : e.state.doc.rangeHasMark(n, i, o);
}
function ce() {
  let e = null;
  function n(e2) {
    let t = document.createElement("div");
    return t.className = "pw-bubble-menu", oe.forEach((n2, i2) => {
      if (i2 > 0) {
        let e3 = document.createElement("span");
        e3.className = "pw-separator", t.appendChild(e3);
      }
      let a = document.createElement("button");
      a.innerHTML = n2.icon, a.title = n2.label, a.setAttribute("data-mark", n2.mark), a.addEventListener("mousedown", (i3) => {
        i3.preventDefault(), i3.stopPropagation();
        let a2 = g.marks[n2.mark];
        toggleMark(a2)(e2.state, e2.dispatch), e2.focus(), r(e2, t);
      }), t.appendChild(a);
    }), t;
  }
  function r(e2, t) {
    t.querySelectorAll("button[data-mark]").forEach((t2) => {
      let n2 = t2.getAttribute("data-mark");
      t2.classList.toggle("active", se(e2, n2));
    });
  }
  function i(e2, t) {
    let { from: n2, to: r2 } = e2.state.selection, i2 = e2.coordsAtPos(n2), a = e2.coordsAtPos(r2), o = e2.dom.getBoundingClientRect(), s = t.getBoundingClientRect(), c = (i2.left + a.right) / 2 - o.left - s.width / 2, l = i2.top - o.top - s.height - 8;
    c = Math.max(4, Math.min(c, o.width - s.width - 4)), t.style.left = `${c}px`, t.style.top = `${l}px`;
  }
  return new Plugin({
    key: ae,
    view(t) {
      e = n(t), e.style.display = "none";
      let a = t.dom.parentElement;
      return a && a.appendChild(e), {
        update(t2) {
          let { empty: n2, from: a2, to: o } = t2.state.selection;
          if (n2 || a2 === o) {
            e.style.display = "none";
            return;
          }
          e.style.display = "flex", r(t2, e), requestAnimationFrame(() => {
            e && e.style.display !== "none" && i(t2, e);
          });
        },
        destroy() {
          e == null ? void 0 : e.remove(), e = null;
        }
      };
    }
  });
}
var le = new PluginKey("typeBadge");
var O = [
  {
    type: "sceneHeading",
    label: "Scene Heading",
...
function de(e, t) {
  ...
  e.dispatch(e.state.tr.setBlockType(r, i, n)), e.focus();
}
function k() {
  let e = null, n = null, r = false;
  function i(e2) {
    let t = document.createElement("div");
    t.className = "pw-type-badge";
    let n2 = document.createElement("button");
    return n2.className = "pw-type-badge-label", n2.addEventListener("mousedown", (t2) => {
      t2.preventDefault(), t2.stopPropagation(), o(e2);
    }), t.appendChild(n2), t;
  }
  function a(e2) {
    let t = document.createElement("div");
    return t.className = "pw-type-dropdown", O.forEach((n2) => {
      let r2 = document.createElement("button");
      r2.setAttribute("data-type", n2.type);
      let i2 = document.createElement("span");
      i2.textContent = n2.label;
      let a2 = document.createElement("span");
      a2.className = "pw-shortcut", a2.textContent = n2.shortcut, r2.appendChild(i2), r2.appendChild(a2), r2.addEventListener("mousedown", (t2) => {
        t2.preventDefault(), t2.stopPropagation(), de(e2, n2.type), l();
      }), t.appendChild(r2);
    }), t;
  }
  function o(e2) {
  ...
  function s(t) {
    e && (n && n.remove(), n = a(t), e.appendChild(n), r = true, u(), c && document.removeEventListener("mousedown", c), c = (t2) => {
      (e == null ? void 0 : e.contains(t2.target)) || l();
    }, setTimeout(() => document.addEventListener("mousedown", c), 0));
  }
  let c = null;
  function l() {
    n == null ? void 0 : n.remove(), n = null, r = false, c && (c = (document.removeEventListener("mousedown", c), null));
  }
  function u() {
    if (!n || !e) return;
    let t = e.getAttribute("data-current-type");
    n.querySelectorAll("button").forEach((e2) => {
      e2.classList.toggle("active", e2.getAttribute("data-type") === t);
    });
  }
  function d(t) {
    if (!e) return;
    let { $from: n2 } = t.state.selection, r2 = n2.before(n2.depth), i2 = t.coordsAtPos(r2 + 1), a2 = t.dom.getBoundingClientRect(), o2 = i2.top - a2.top;
    e.style.left = "-120px", e.style.top = `${o2}px`;
  }
  function f(t) {
    if (!e) return;
    let n2 = ue(t), i2 = O.find((e2) => e2.type === n2);
    if (!i2) {
      e.style.display = "none";
      return;
    }
    e.style.display = "flex", e.setAttribute("data-current-type", n2);
    let a2 = e.querySelector(".pw-type-badge-label");
    a2 && (a2.textContent = i2.label), d(t), r && u();
  }
  return new Plugin({
    key: le,
    view(t) {
      return e = i(t), e.style.display = "none", t.dom.parentElement.appendChild(e), requestAnimationFrame(() => f(t)), {
        update(e2) {
          requestAnimationFrame(() => f(e2));
        },
        destroy() {
          l(), e == null ? void 0 : e.remove(), e = null;
        }
      };
    }
  });
}
var A = new PluginKey("sceneNumbers");
var j = new Plugin({
  key: A,
  state: {
    init(e, t) {
    ...
    apply(e, t) {
      return e.docChanged ? M(e.doc) : t.map(e.mapping, e.doc);
    }
  },
  props: { decorations(e) {
    return A.getState(e);
...
function M(e) {
  ...
  return e.forEach((e2, i) => {
    if (e2.type.name === "sceneHeading") {
      n++;
      let e3 = String(n);
      t.push(Decoration.widget(i + 1, () => {
        let t2 = document.createElement("span");
        return t2.className = "pw-scene-number pw-scene-number-left", t2.textContent = e3, t2.contentEditable = "false", t2;
      }, {
        side: -1,
        key: `sn-l-${i}-${e3}`
      })), t.push(Decoration.widget(i + 1, () => {
        let t2 = document.createElement("span");
        return t2.className = "pw-scene-number pw-scene-number-right", t2.textContent = e3, t2.contentEditable = "false", t2;
      }, {
        side: 1,
        key: `sn-r-${i}-${e3}`
      }));
...
var N = new PluginKey("fadeInAlign");
function P() {
  return new Plugin({
    key: N,
    view() {
      return { update(e) {
        e.dom.querySelectorAll(".pm-transition").forEach((e2) => {
          let t = (e2.textContent || "").toUpperCase().trim();
          e2.classList.toggle("pw-fade-in", /^FADE\s+IN[.:]?$/.test(t));
        });
      } };
    }
  });
...
function I(e) {
  ...
  return !!(F.has(t) || /^[A-Z\s]+TO:$/.test(t));
}
function L(e) {
  let t = e.trim();
  return !!(/^(INT\.|EXT\.|INT\.\/EXT\.|INT\/EXT\.|I\/E\.)\s/i.test(t) || /^\.[A-Z]/.test(t));
}
function R(e, t) {
  let n = e.trim();
  return !(!/^[A-Z][A-Z\s\.\-']+(\s*\([\w\s\.\']+\))?$/.test(n) || I(e) || /^(INT|EXT|FADE|CUT|DISSOLVE|SMASH|MATCH|WIPE|JUMP|IRIS|TIME)$/.test(n) || !t || t.trim() === "" || n.length < 2);
}
function z(e) {
  let t = e.split("\n"), n = [], r = 0;
  for (; r < t.length; ) {
    ...
    if (L(e2)) {
      let t2 = e2.trim().replace(/^\./, "").toUpperCase();
      n.push({
        type: "sceneHeading",
        text: t2
      }), r++;
    ...
    if (R(e2, t[r + 1])) {
      for (n.push({
        type: "character",
        text: e2.trim()
      }), r++; r < t.length && t[r].trim() !== ""; ) {
        let e3 = t[r].trimEnd();
        if (/^\s*\(.*\)\s*$/.test(e3)) {
          let t2 = e3.trim().replace(/^\(/, "").replace(/\)$/, "");
          n.push({
            type: "parenthetical",
            text: t2
          });
    ...
    for (; r < t.length && t[r].trim() !== ""; ) n.push({
      type: "action",
      text: t[r].trimEnd()
    }), r++;
  }
...
function B(e) {
  let t = z(e).map((e2) => {
    let t2 = g.nodes[e2.type], n = e2.text ? g.text(e2.text) : void 0;
    return t2.create({}, n);
  });
  return t.length === 0 && t.push(g.nodes.action.create()), g.nodes.doc.create({}, t);
}
var V = {
...
function H(e) {
  ...
  return n.includes("Bold") && t.push(g.marks.bold.create()), n.includes("Italic") && t.push(g.marks.italic.create()), n.includes("Underline") && t.push(g.marks.underline.create()), t;
}
function fe(e) {
  let t = e.querySelectorAll("Text"), n = [];
  return t.forEach((e2) => {
...
function U(e) {
  ...
  if (n) throw Error(`Invalid FDX file: ${n.textContent}`);
  let r = t.querySelectorAll("Content > Paragraph"), i = [];
  return r.forEach((e2) => {
    let t2 = V[e2.getAttribute("Type") || "Action"] || "action", n2 = g.nodes[t2];
    if (!n2) return;
    let r2 = fe(e2);
    if (t2 === "parenthetical" && r2.length === 1) {
      let e3 = r2[0].text || "";
      if (e3.startsWith("(") && e3.endsWith(")")) {
        let t3 = e3.slice(1, -1);
        t3 ? i.push(n2.create({}, g.text(t3))) : i.push(n2.create());
        return;
      }
    }
    r2.length > 0 ? i.push(n2.create({}, r2)) : i.push(n2.create());
  }), i.length === 0 && i.push(g.nodes.action.create()), g.nodes.doc.create({}, i);
}
function W(e) {
  let t = [];
  for (let n of e) {
    if (n.heading) {
      let e2 = n.heading.toUpperCase();
      t.push(g.nodes.sceneHeading.create({}, g.text(e2)));
    }
    if (n.action_content) {
      let e2 = z(n.action_content);
      for (let n2 of e2) {
        let e3 = g.nodes[n2.type], r = n2.text ? g.text(n2.text) : void 0;
        t.push(e3.create({}, r));
      }
    }
  }
...
function ge(e) {
  ...
  let t = e.filter((e2) => he.has(e2.type));
  return t.length > 0 ? t : void 0;
}
function _e(e) {
  if (!e || !Array.isArray(e)) return [];
  let t = [];
  for (let n of e) if (n.type === "text" && n.text) {
    let e2 = ge(n.marks), r = e2 ? e2.map((e3) => g.marks[e3.type].create(e3.attrs)) : void 0;
    t.push(g.text(n.text, r));
  } else n.type;
  return t;
}
function G(e) {
  var _a, _b;
  if (!e || e.type !== "doc" || !Array.isArray(e.content)) return g.nodes.doc.create({}, [g.nodes.action.create()]);
  let t = [];
  for (let n of e.content) if (!(!n || typeof n != "object")) {
    if (n.type !== "paragraph" && n.type !== "heading" && g.nodes[n.type]) {
      try {
        t.push(Node.fromJSON(g, n));
      } catch {
      }
      continue;
    }
    if (n.type === "paragraph") {
      let e2 = pe[((_a = n.attrs) == null ? void 0 : _a.class) || "action"] || "action", r = g.nodes[e2];
      if (!r) continue;
      let i = _e(n.content), a = e2 === "sceneHeading" ? { id: ((_b = n.attrs) == null ? void 0 : _b.sceneId) || null } : {};
      t.push(r.create(a, i.length > 0 ? i : void 0));
      continue;
    }
  }
  return t.length === 0 && t.push(g.nodes.action.create()), g.nodes.doc.create({}, t);
  ...
  return e.forEach((e2) => {
    ...
    e2.forEach((e3) => {
      if (e3.isText) {
        ...
        e3.marks.length > 0 && (t2.marks = e3.marks.map((e4) => {
          let t3 = { type: e4.type.name };
          return Object.keys(e4.attrs).length > 0 && (t3.attrs = e4.attrs), t3;
        })), r.push(t2);
      }
    });
    let i = {
    ...
    r.length > 0 && (i.content = r), t.push(i);
  }), {
    type: "doc",
    content: t
  };
...
function K(e) {
  let t = [];
  return e.forEach((e2) => {
    let n = e2.type.name, r = e2.textContent;
    switch (n) {
      case "sceneHeading":
        t.length > 0 && t.push(""), t.push(r.toUpperCase());
        break;
      case "action":
        t.length > 0 && t.push(""), t.push(r);
        break;
      case "character":
        t.length > 0 && t.push(""), t.push(r.toUpperCase());
        break;
...
function be(e) {
  if (e.childCount === 0) return "<Text></Text>";
  let t = [];
  return e.forEach((e2) => {
    let n = q(e2.text || ""), r = [];
    e2.marks.forEach((e3) => {
    ...
    let i = r.length > 0 ? ` Style="${r.join("+")}"` : "";
    t.push(`<Text${i}>${n}</Text>`);
  }), t.join("");
}
function J(e) {
  let t = [];
  return e.forEach((e2) => {
    let n = e2.type.name;
    if (n === "pageBreak") return;
    let r = ye[n];
    if (!r) return;
    let i;
    i = n === "parenthetical" ? `<Text>(${q(e2.textContent)})</Text>` : be(e2), t.push(`    <Paragraph Type="${r}">
      ${i}
    </Paragraph>`);
...
function Y(e) {
  ...
  return e.forEach((e2) => {
    ...
    switch (r) {
      case "sceneHeading":
        n++, t.push(`<p class="pm-scene-heading" data-type="scene-heading"><span class="pw-sn pw-sn-l">${n}</span>${i}<span class="pw-sn pw-sn-r">${n}</span></p>`);
        break;
      case "action":
        t.push(`<p class="pm-action" data-type="action">${i}</p>`);
        break;
      case "character":
        t.push(`<p class="pm-character" data-type="character">${i}</p>`);
        break;
      case "dialogue":
        t.push(`<p class="pm-dialogue" data-type="dialogue">${i}</p>`);
        break;
      case "parenthetical":
        t.push(`<p class="pm-parenthetical" data-type="parenthetical">${i}</p>`);
        break;
      case "transition": {
        let n2 = e2.textContent.toUpperCase().includes("FADE IN") ? " pw-fade-in" : "";
        t.push(`<p class="pm-transition${n2}" data-type="transition">${i}</p>`);
        break;
      }
      default:
        i && t.push(`<p class="pm-action" data-type="action">${i}</p>`);
    }
  }), t.join("\n");
}
function xe(e) {
...
function Se(e) {
  let t = [];
  return t.push('<div class="page cover-page">'), t.push('<div class="cover-title-block">'), e.title && t.push(`<p class="cover-title">${X(e.title)}</p>`), e.author && (t.push('<p class="cover-credit">Written by</p>'), t.push(`<p class="cover-author">${X(e.author)}</p>`)), e.basedOn && t.push(`<p class="cover-based-on">${X(e.basedOn)}</p>`), t.push("</div>"), t.push('<div class="cover-info-block">'), e.draftDate && t.push(`<p class="cover-info">${X(e.draftDate)}</p>`), e.copyright && t.push(`<p class="cover-info">${X(e.copyright)}</p>`), e.contactInfo && t.push(`<p class="cover-info">${X(e.contactInfo)}</p>`), t.push("</div>"), t.push("</div>"), t.join("\n");
}
function Q(e, t = {}) {
  var _a;
  if (typeof window > "u") throw Error("exportToPDF requires a browser environment.");
  let n = Y(e), r = Z((t.coverPage ? Se(t.coverPage) : "") + n, t.title || ((_a = t.coverPage) == null ? void 0 : _a.title)), i = window.open("", "_blank");
  if (!i) throw Error("Could not open print window. Please allow popups.");
  i.document.write(r), i.document.close(), i.onafterprint = () => {
  };
  let a = () => {
    !i || i.closed || (i.document.querySelectorAll(".page").length > 0 ? i.document.fonts ? i.document.fonts.ready.then(() => {
      setTimeout(() => i.print(), 200);
    }) : setTimeout(() => i.print(), 500) : setTimeout(a, 100));
  };
  setTimeout(a, 300);
}
function $(e, t) {
...
var Ce = class {
  constructor(t) {
    var _a;
    this._readingMode = false, this.options = t;
    let n = t.doc ? Node.fromJSON(g, t.doc) : t.content ? B(t.content) : g.nodes.doc.create({}, [g.nodes.sceneHeading.create()]), r = [
      re,
      S,
      ...t.history === false ? [] : [keymap({
        "Mod-z": undo,
        "Mod-y": redo,
        "Shift-Mod-z": redo
      })],
      keymap(baseKeymap),
      ...t.history === false ? [] : [history()],
      ie3,
      j,
      P()
    ];
    t.bubbleMenu !== false && r.push(ce()), t.typeBadge !== false && r.push(k()), ((_a = t.extraPlugins) == null ? void 0 : _a.length) && r.push(...t.extraPlugins);
    let i = EditorState.create({
      doc: n,
      plugins: r
    });
    t.container.style.position = "relative", this.view = new EditorView(t.container, {
      state: i,
      editable: () => !this._readingMode,
      handleDOMEvents: {
        dragstart: (e, t2) => (t2.preventDefault(), true),
        dragover: (e, t2) => (t2.preventDefault(), true),
        drop: (e, t2) => (t2.preventDefault(), true)
      },
      handleDrop: () => true,
      dispatchTransaction: (e) => {
        let n2 = this.view.state.apply(e);
        this.view.updateState(n2), e.docChanged && t.onChange && t.onChange(n2.doc);
      }
    }), t.attribution !== false && this.renderAttribution(t.container), t.darkMode && this.setDarkMode(true);
  }
  renderAttribution(e) {
    let t = document.createElement("a");
    t.href = "https://plotwell.co", t.target = "_blank", t.rel = "noopener", t.className = "plotwell-attribution", t.textContent = "Powered by plotwell", e.appendChild(t);
  }
  replaceDoc(e) {
    let t = this.view.state.tr.replaceWith(0, this.view.state.doc.content.size, e.content);
  ...
  importJSON(e) {
    this.replaceDoc(Node.fromJSON(g, e));
  }
  importTiptap(e) {
    this.replaceDoc(G(e));
  }
  toFountain() {
    return K(this.view.state.doc);
  }
  toFDX() {
    return J(this.view.state.doc);
  }
  toPDF(e) {
    Q(this.view.state.doc, e);
  }
  toPrintHTML(e) {
    return $(this.view.state.doc, e);
  }
  toJSON() {
  ...
  setReadingMode(e) {
    this._readingMode = e, this.view.dom.classList.toggle("pw-reading-mode", e), this.view.setProps({ editable: () => !this._readingMode });
  }
  setDarkMode(e) {
    let t = this.view.dom.closest(".plotwell-editor-wrap");
    t && t.classList.toggle("pw-dark", e);
  }
  getStats() {
    let e = this.view.state.doc, t = 0, n = 0, r = 0, i = 0;
    e.forEach((e2) => {
      let a2 = e2.textContent, o2 = a2.trim() ? a2.trim().split(/\s+/).length : 0;
      switch (e2.type.name) {
        case "sceneHeading":
          t++, n += o2, r += a2.length;
          break;
    ...
    let a = this.view.dom.querySelectorAll(".pw-page-separator").length + 1, o = n > 0 ? Math.round(i / n * 100) : 0;
    return {
      sceneCount: t,
      wordCount: n,
      characterCount: r,
      pageCount: a,
      dialoguePercentage: o
    };
  }
  destroy() {
    this.view.destroy();
...
//# sourceMappingURL=@plotwell_editor.js.map
