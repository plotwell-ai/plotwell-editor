    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <header className="border-b border-slate-200 px-4 md:px-8 h-14 flex items-center justify-between">
        <a href="https://plotwell.co" className="flex items-center gap-2">
          ...
          <span className="text-xs text-slate-400 font-medium hidden sm:inline">scripts</span>
        </a>
      ...
      <footer className="border-t border-slate-100 px-4 py-6 text-center">
        <p className="text-xs text-slate-400">
          A tool by{' '}
          <a href="https://plotwell.co" className="text-amber-600 hover:text-amber-700 font-medium">
            plotwell
          </a>
          {' '}— the professional screenplay platform
        </p>
      </footer>
    </div>
  )
